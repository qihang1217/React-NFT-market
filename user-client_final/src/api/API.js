...
//根据NFT ID确认铸造成功
export const reqConfirmMinted = (productId, tokenId, tokenURI) => {
    return HttpUtil.get(ApiUtil.API_CONFIRM_MINTED + `?productId=${productId}&tokenId=${tokenId}&tokenURI=${tokenURI}`)
}
